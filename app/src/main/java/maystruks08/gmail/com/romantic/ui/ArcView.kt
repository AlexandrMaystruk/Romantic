...
class ArcView @JvmOverloads constructor(
    ...
    private val backgroundStartColor = ContextCompat.getColor(context, R.color.colorRed)
    private val backgroundEndColor = ContextCompat.getColor(context, R.color.colorGreen)
